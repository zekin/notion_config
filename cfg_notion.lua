...
defbindings("WFrame", {
  kpress(META..ALTMETA.."H", "_:manager():nextto(_,'left'):attach(_:current(), { switchto=true })"),
  kpress(META..ALTMETA.."J", "_:manager():nextto(_,'down'):attach(_:current(), { switchto=true }); ioncore.goto_next(_chld, 'down')"),
  kpress(META..ALTMETA.."K", "_:manager():nextto(_,'up'):attach(_:current(), { switchto=true } ); ioncore.goto_next(_chld, 'up')"),
  kpress(META..ALTMETA.."L", "_:manager():nextto(_,'right'):attach(_:current(), { switchto=true }); ioncore.goto_next(_chld, 'right')"),
})
-- APP_NOTES_TOOL
